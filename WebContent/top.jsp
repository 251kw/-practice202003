					...
					<table class="table">
						<tr>
							...
							<td><input class="form-control" type="text"
								placeholder="hello" name="shout" value="" size="60" /></td>
	...
	<div class="padding-y-5">
		<div style="width: 40%" class="container padding-y-5">
			...
			<form action="./MessageSearchInput" method="post">
				...
				<div class="box">
					<input class="btn" type="submit" name="update" value="編集" /> <input
						class="btn" type="submit" name="delete" value="削除" /> <input
						class="btn" style="float: center;" type="submit" name="full"
						value="全選択する" /> <input class="btn" style="float: center;"
						type="submit" name="clear" value="解除" />
				</div>
			</form>
		</div>
	</div>
